...
import { User, Mail, Calendar, Music, Heart, TrendingUp, Edit, LogOut, Trash2, Settings } from 'lucide-react'
...
const Profile = () => {
  ...
  const stats = [
    { label: 'Songs Played', value: '2,847', icon: Music, color: 'from-purple-500 to-purple-600' },
    { label: 'Favorites', value: '342', icon: Heart, color: 'from-pink-500 to-pink-600' },
    { label: 'Moods Tracked', value: '156', icon: TrendingUp, color: 'from-blue-500 to-blue-600' },
    { label: 'Playlists', value: '24', icon: Music, color: 'from-emerald-500 to-emerald-600' },
  ]
