...
export const API_ENDPOINTS = {
  ...
  UPDATE_SETTINGS: '/users/profile',
  GET_STATISTICS: '/emotion-history/stats',

  // Emotions
  DETECT_EMOTION: '/emotion-history',
  GET_EMOTION_HISTORY: '/emotion-history',
  GET_EMOTION: '/emotion-history',
  UPDATE_EMOTION: '/emotion-history',
  DELETE_EMOTION: '/emotion-history',
  GET_EMOTION_STATISTICS: '/emotion-history/stats',
  GET_EMOTION_TRENDS: '/emotion-history/stats',
  ...
  SPOTIFY_SAVE_TRACK: '/spotify/save-track',
  SPOTIFY_SYNC: '/spotify/sync',

  // Feedback
  SUBMIT_FEEDBACK: '/feedback',
  GET_MY_FEEDBACK: '/feedback/my-feedback',
  GET_ALL_FEEDBACK: '/feedback/all',
  UPDATE_FEEDBACK: '/feedback',
  DELETE_FEEDBACK: '/feedback',
  GET_FEEDBACK_STATS: '/feedback/stats',
  GET_FEEDBACK_BY_STATUS: '/feedback/status',

  // Genres
  GET_GENRES: '/genres',
  GET_GENRE: '/genres',
  GET_SONGS_BY_GENRE: '/songs/genre',
}
