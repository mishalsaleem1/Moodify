        ...
        <div className="bg-white/4 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-gray-50 text-gray-900 font-semibold px-6 py-3 rounded-xl flex items-center justify-center space-x-3 shadow-lg transition-all hover:scale-[1.02]"
            >
